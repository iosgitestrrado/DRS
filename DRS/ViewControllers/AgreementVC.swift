...
class AgreementVC: UIViewController, WKNavigationDelegate {
    var strTitle:String = ""
    @IBOutlet weak var webkitAgree: WKWebView!
    func changeLanguage() {
        ...
        if sharedDefault.getLanguage() == 1 {
            ...
            do {
                ...
                if let text = xml.resource.Agreement_Title.text {
                    strTitle = text
                 self.title = strTitle
                }
